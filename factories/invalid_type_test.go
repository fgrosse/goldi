...
import (
	...
	"github.com/fgrosse/goldi/factories"
	"fmt"
)
...
var _ = Describe("InvalidType", func() {
	It("should implement the TypeFactory interface", func() {
		...
		factory = factories.NewInvalidType(fmt.Errorf("Something bad happened"))
	...
	Describe("Arguments()", func() {
		It("should return an empty list", func() {
			typeDef := factories.NewInvalidType(fmt.Errorf("Something bad happened"))
	...
	Describe("Generate()", func() {
		It("should return its error", func() {
			...
			typeDef := factories.NewInvalidType(e)
